...
namespace Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // Pdfjs
            bundles.Add(new ScriptBundle("~/plugins/easytabs").Include(
                      "~/Scripts/plugins/easytabs/jquery.easytabs.min.js"));

            // inputMask
            bundles.Add(new ScriptBundle("~/plugins/inputMask").Include(
                      "~/Scripts/plugins/inputMask/jquery.mask.min.js"));

            // inputMask
            bundles.Add(new ScriptBundle("~/plugins/cbotUserTypeMethods").Include(
                      "~/Scripts/plugins/recursiveMethods/cboUserTypeMethods.js"));


            // validador cpf
            bundles.Add(new ScriptBundle("~/plugins/ValidadorCPF").Include(
                      "~/Scripts/plugins/ValidadorCPF.js"));

            // datepicker
            bundles.Add(new ScriptBundle("~/plugins/boot3DatePicker").Include(
                      "~/Scripts/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js"));

            bundles.Add(new StyleBundle("~/plugins/boot3DatePickerStyles").Include(
                    "~/Scripts/plugins/bootstrap-datepicker/css/bootstrap-datepicker.css"));

            //thumbnails
            bundles.Add(new ScriptBundle("~/plugins/thumbnail").Include(
                   "~/Scripts/plugins/nailthumb/jquery.nailthumb.1.1.min.js"));

            bundles.Add(new StyleBundle("~/plugins/thumbnailStyle").Include(
                    "~/Scripts/plugins/nailthumb/jquery.nailthumb.1.1.min.css"));

            //count down
            bundles.Add(new ScriptBundle("~/plugins/countdown").Include(
                 "~/Scripts/plugins/jquery.countdown-2.1.0/jquery.countdown.js"));

            //persistence, localstorage, cookies
            bundles.Add(new ScriptBundle("~/plugins/basil").Include(
                 "~/Scripts/plugins/Wisembly-basil.js-f7ffb3d/build/basil.js"));

            //formatador de datas
            bundles.Add(new ScriptBundle("~/plugins/dateFormat").Include(
                 "~/Scripts/plugins/dateFormat/dateFormat.min.js"));

            //formatador de datas
            bundles.Add(new ScriptBundle("~/Scripts/fieldValidator").Include(
